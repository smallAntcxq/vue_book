    ...
    <div class="deposit-top">
      ...
      <div>
        <img
          ...
          class="deposittop-img"
        >
      </div>
    </div>
    <div class="deposit-box">
      <div class="deposit-btnzo">
        500书币
      </div>
      <div
        class="deposit-btn"
...
export default {
    ...
    methods: {
        ...
        amountChang(){
            let depositbtn = document.querySelector(".deposit-btnzo")
